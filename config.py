...
# SMTP_ACCOUNTS contient désormais des comptes Gmail OAuth :
# [{"email":"...", "client_id":"...", "client_secret":"...", "refresh_token":"..."}]
# Le nom de la variable est conservé pour ne pas casser Render.
...
WHATSAPP_RECIPIENTS = json.loads(
    os.getenv("WHATSAPP_RECIPIENTS", '["support@support.whatsapp.com"]')
)
